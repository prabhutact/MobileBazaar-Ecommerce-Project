...
const productDetails = async (req, res) => {
  try {
    ...
    if (userData) {
      ...
      res.render('user/productDetails', { product, outOfStock, productExistInCart, ProductExist, userData })
      
    }else {
      
      res.render('user/productDetails', { product, outOfStock, productExistInCart: false });
    }
